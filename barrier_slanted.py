...
def setup(kernel_language='Fortran', solver_type='classic', use_petsc=False,
    ...
    solver.order = 1
    # solver.limiters =1 # pyclaw.limiters.tvd.minmod_limiter(r,cfl)
    ...
    state.grid.add_gauges([(0.617676,0.20288)])#[(0.382324,0.86212464)])#
...
def gauge_spots(current_data): #0.117676  0.32962
    gauge_points = [(0.617676,0.20288)]#[(0.382324,0.86212464)]#
    axis = plt.gca()
    x_1 = 1.0 #0.995#
    x_0 = 0.0
    y_0 =  0.354#0.005#
